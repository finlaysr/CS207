        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.print("Enter the position (index) to add the item (0 to " + list.size() + "): "); // legal position reminder
                ...
                case 2:
                    System.out.print("Enter the position (index) to add the item (0 to " + (list.size()-1) + "): "); // legal position reminder
